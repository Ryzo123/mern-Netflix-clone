  ...
  return (
    <div className='hero-bg relative'>
        ...
        <div className='flex flex-col items-center justify-center text-center py-40 text-white max-w-6xl mx-auto'>
            ...
            <form className='flex flex-col md:flex-row gap-4 w-1/2'onSubmit={onsubmithander}>
            <input
				    type='email'
        ...
        <div className='py-10 bg-black text-white'>
            ...
            <div className='flex max-w-6xl mx-auto items-center justify-center flex-col md:flex-row px-4 md:px-2'>
                ...
                <div className='flex-1 text-center md:text-left'>
                    <h2 className='text-4xl md:text-6xl font-extrabold mb-4'>Enjoy on your TV</h2>
            ...
            <div className='flex max-w-6xl mx-auto items-center justify-center flex-col-reverse md:flex-row px-4 md:px-2'>
                ...
                <div className='flex-1 '>
                    <div className='relative'>
                        <img src='/stranger-things-lg.png' alt='stranger thing image'
